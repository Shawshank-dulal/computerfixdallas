...
const Mission = () => {
  return (
    ...
    <div class="mt-20 md:mt-32">
      <Image className='rounded-xl' width={1200} height={1200} src="https://images.unsplash.com/photo-1529156069898-49953e39b3ac?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=2832&q=80" alt="" class="aspect-[5/2] w-full object-cover xl:rounded-3xl"/>
    </div>
    </div>
  )
}
